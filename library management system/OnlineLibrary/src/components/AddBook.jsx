        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 block w-full p-3 rounded-lg border border-white-300 focus:white-[#D37C3D] focus:border-[#D37C3D] focus:outline-none"
            />
          ...
          <div className="text-center">
            <button
              type="submit"
              className="w-full py-3 mt-4 bg-[#D37C3D] text-white text-lg font-semibold rounded-lg hover:bg-[#C27B2B] focus:outline-none focus:white-2 focus:white-[#766d67] focus:white-opacity-50"
            >
              Add Book
            </button>
          </div>
